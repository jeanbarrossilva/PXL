if (typeof kotlin === 'undefined') {
  ...
  Game.prototype.handleKey_kc24xn$ = function (event) {
    var tmp$;
    var tmp$_0;
    if ((tmp$ = this.currentPlayer_0) != null) {
      switch (event.key) {
        case 'ArrowUp':
          tmp$.y = tmp$.y - 1 | 0;
          break;
  ...
  function main() {
    ...
    document.addEventListener('keydown', EventListener(main$lambda$lambda(game)));
  }
